...
class OnlineStatusTracker:
    ...
    def __post_init__(self):
        """Post init."""
        # A token bucket normally starts full. Starting with one request and no
        # tokens makes every online run ramp up over its first minute even when
        # the caller supplied a high, known-safe local endpoint limit.
